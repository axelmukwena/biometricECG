...
public class TF_TD_Libraries$Butter
{
  private TF_TD_Libraries.Complex a = new TF_TD_Libraries.Complex(0.0D, -1.0D);

  public TF_TD_Libraries$Butter(TF_TD_Libraries paramTF_TD_Libraries)
  {
  }

  public TF_TD_Libraries.Butter_Return ButterworthBandPassFilter(int paramInt, double[] paramArrayOfDouble)
  {
    ...
    return (TF_TD_Libraries.Butter_Return)new TF_TD_Libraries.Butter_Return(this.b, paramInt, paramArrayOfDouble);
  }
}

/* Location:           C:\Users\Chris\Desktop\ThinkGear SDK for Android(MTK)\libs\ThinkGearPackX.jar
 * Qualified Name:     com.neurosky.thinkgear.TF_TD_Libraries.Butter
