...
public class EEGAlgorithmToolbox$Eyeblink_EEG$FFT
{
  private double[] a;
  private double[] b;

  public EEGAlgorithmToolbox$Eyeblink_EEG$FFT(EEGAlgorithmToolbox.Eyeblink_EEG paramEyeblink_EEG)
  {
  }

  public EEGAlgorithmToolbox.Eyeblink_EEG.FFTResult calculateFFT(double[] paramArrayOfDouble1, double[] paramArrayOfDouble2, int paramInt1, int paramInt2)
  {
    ...
    return new EEGAlgorithmToolbox.Eyeblink_EEG.FFTResult(this.c, this.a, this.b);
  }
}

/* Location:           C:\Users\Chris\Desktop\ThinkGear SDK for Android(MTK)\libs\ThinkGearPackX.jar
 * Qualified Name:     com.neurosky.thinkgear.EEGAlgorithmToolbox.Eyeblink_EEG.FFT
