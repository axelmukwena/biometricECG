...
public class TF_TD_Libraries$Complex
{
  private double a;
  private double b;
  ...
  public TF_TD_Libraries$Complex(double paramDouble1, double paramDouble2)
  {
    this.a = paramDouble1;
    this.b = paramDouble2;
  }
 ...
 * Qualified Name:     com.neurosky.thinkgear.TF_TD_Libraries.Complex
