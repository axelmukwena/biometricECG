...
public class EEGAlgorithmToolbox$Butter
{
  private EEGAlgorithmToolbox.Complex a = new EEGAlgorithmToolbox.Complex(0.0D, -1.0D);

  public EEGAlgorithmToolbox$Butter(EEGAlgorithmToolbox paramEEGAlgorithmToolbox)
  {
  }
  ...
  public EEGAlgorithmToolbox.Butter_Return ButterworthBandPassFilter(int paramInt, double[] paramArrayOfDouble)
  {
    ...
    EEGAlgorithmToolbox.CVector localCVector = new EEGAlgorithmToolbox.CVector(((Butter)localObject1).b, 2 * arrayOfDouble2 + 1);
    ...
    for (int i3 = 0; i3 < arrayOfDouble7.length; i3++)
      EEGAlgorithmToolbox.CVector.a(localCVector)[i3] = EEGAlgorithmToolbox.Complex.CExp(EEGAlgorithmToolbox.Complex.CMultipleValue(EEGAlgorithmToolbox.Complex.CMultipleValue(((Butter)localObject1).a, d10), arrayOfDouble7[i3]));
    double d12 = 0.0D;
    double d13 = 0.0D;
 ...
 * Qualified Name:     com.neurosky.thinkgear.EEGAlgorithmToolbox.Butter
