...
public class TF_TD_Libraries$TF_TD_eyeblink_v2$SWT
{
  private double[] a;
  private double[] b;
  private double[] c;
  ...
  public TF_TD_Libraries$TF_TD_eyeblink_v2$SWT(TF_TD_Libraries.TF_TD_eyeblink_v2 paramTF_TD_eyeblink_v2)
  {
  }
  ...
  public double[][] SWT_Fun(double[] paramArrayOfDouble, int paramInt, String paramString)
  {
    ...
    if (paramString < paramInt)
    {
      ...
      arrayOfDouble2 = new double[localSWT.k.length];
      for (i2 = 0; i2 < localSWT.k.length; i2++)
      {
        i3 = (int)localSWT.k[i2];
 ...
 * Qualified Name:     com.neurosky.thinkgear.TF_TD_Libraries.TF_TD_eyeblink_v2.SWT
