...
public class EEGAlgorithmToolbox$FFT_EEG
{
  private double[] a;
  private double[] b;

  public EEGAlgorithmToolbox$FFT_EEG(EEGAlgorithmToolbox paramEEGAlgorithmToolbox)
  {
  }

  public EEGAlgorithmToolbox.FFTResult calculateFFT(double[] paramArrayOfDouble1, double[] paramArrayOfDouble2, int paramInt1, int paramInt2)
  {
    ...
    return new EEGAlgorithmToolbox.FFTResult(this.c, this.a, this.b);
  }
}

/* Location:           C:\Users\Chris\Desktop\ThinkGear SDK for Android(MTK)\libs\ThinkGearPackX.jar
 * Qualified Name:     com.neurosky.thinkgear.EEGAlgorithmToolbox.FFT_EEG
